...
#pragma GCC diagnostic pop
    ...
    *bit_ofs += 4;
    for (i=0; i < orientation_covariance_len; i++) {
        {
...
#pragma GCC diagnostic pop
    ...
    *bit_ofs += 4;
    for (i=0; i < angular_velocity_covariance_len; i++) {
        {
...
#pragma GCC diagnostic pop
    ...
    for (i=0; i < linear_acceleration_covariance_len; i++) {
        {
...
#pragma GCC diagnostic pop
#endif
    for (i=0; i < msg->orientation_covariance.len; i++) {
        {
            uint16_t float16_val;
            canardDecodeScalar(transfer, *bit_ofs, 16, true, &float16_val);
...
#pragma GCC diagnostic pop
#endif
    for (i=0; i < msg->angular_velocity_covariance.len; i++) {
        {
            uint16_t float16_val;
            canardDecodeScalar(transfer, *bit_ofs, 16, true, &float16_val);
...
#pragma GCC diagnostic pop
#endif
    for (i=0; i < msg->linear_acceleration_covariance.len; i++) {
        {
            uint16_t float16_val;
            canardDecodeScalar(transfer, *bit_ofs, 16, true, &float16_val);
